...
from layers.Pathformer.layers.Embedding import *
...
class Transformer_Layer(nn.Module):
    ...
    def forward(self, x):
        ...
        # min_length = min(new_x.shape[1], intra_out_concat.shape[1], inter_out.shape[1])
        # out = new_x[:, :min_length] + intra_out_concat[:, :min_length] + inter_out[:, :min_length]
